...
def main():
    ...
    if training_args.do_train:
        ...
        for id in dataset_id:
            ...
            if "anli" in id:
                ...
                ds = train_dataset.filter(lambda ex: ex['label'] != -1)
        ...
        train_dataset = datasets.concatenate_datasets(all_ds)
    ...
    if training_args.do_eval:
        ...
        if  any(item in ("anli","facebook/anli") for item in dataset_id):
            anli_r1_train = datasets.load_dataset("anli", split="test_r1")
            anli_r2_train = datasets.load_dataset("anli", split="test_r2")
            anli_r3_train = datasets.load_dataset("anli", split="test_r3")
