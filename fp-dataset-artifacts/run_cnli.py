...
def main():
    ...
    if training_args.do_train:
        ...
        # negation_only_data_set = negation_only_data_set.filter(lambda example: example["label"] != -1)
        # negations with only one sentence s2 - not feasible
        # negation_data_set = datasets.load_dataset('json', features=negation_only_features, data_files="/Users/viksabnis/nlp/aug_snli_50/aug_snli/negations.jsonl")
        # negation_data_set = negation_data_set.filter(lambda example: example["label"] != -1)
        itscleft_data_set = datasets.load_dataset('json', features=negation_only_features, data_files="/Users/viksabnis/nlp/aug_snli_50/aug_snli/itclefts_s2.jsonl", split='train[:50%]')
        itscleft_data_set = itscleft_data_set.filter(lambda example: example["label"] != -1)
        swap_subj_obj_data_set = datasets.load_dataset('json', features=negation_only_features, data_files="/Users/viksabnis/nlp/aug_snli_50/aug_snli/subj_obj_swap_s2.jsonl", split='train[:50%]')
        swap_subj_obj_data_set = swap_subj_obj_data_set.filter(lambda example: example["label"] != -1)
        passive_data_set = datasets.load_dataset('json', features=negation_only_features, data_files="/Users/viksabnis/nlp/aug_snli_50/aug_snli/passive_s2.jsonl", split='train[:50%]')
        passive_data_set = passive_data_set.filter(lambda example: example["label"] != -1)


        # cnli_data_set = datasets.load_dataset('json', features=cnli_features, data_files="/Users/viksabnis/nlp/CNLI-generalization/data/preprocessed/data/counterfactual_nli/train.jsonl")
        # cnli_data_set = cnli_data_set.filter(lambda example: example["label"] != -1)
        # print(cnli_data_set['train'])
        # anli_r1_train = datasets.load_dataset("facebook/anli", split="train_r1")
        # anli_r2_train = datasets.load_dataset("facebook/anli", split="train_r2")
        # anli_r3_train = datasets.load_dataset("facebook/anli", split="train_r3")
        ...
        # print(snli_train)
        # snli_train = snli_train.filter(lambda example: example["label"] != -1)
        # print(f"{anli_all_train=}")
        # print(f"{snli_train=}")
        # dataset = datasets.concatenate_datasets([anli_all_train, snli_train])
        # dataset = datasets.concatenate_datasets([snli_train, cnli_data_set['train'], anli_all_train])
        # dataset = datasets.concatenate_datasets([snli_train, cnli_data_set['train'], unli_data_set['train']])
        # dataset = datasets.concatenate_datasets([snli_train, unli_data_set['train']])
        # dataset = unli_data_set['train']
        # dataset = cnli_data_set['train']
        # dataset = datasets.concatenate_datasets([cnli_data_set['train'], unli_data_set['train']])
        # dataset = anli_all_train
        # dataset = negation_only_data_set['train']
        # dataset = negation_data_set['train']
        # dataset = itscleft_data_set['train']
