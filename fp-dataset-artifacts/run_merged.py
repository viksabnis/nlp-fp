...
def main():
    ...
    if training_args.do_train:
        anli_r1_train = datasets.load_dataset("facebook/anli", split="train_r1[:50%]")
        anli_r2_train = datasets.load_dataset("facebook/anli", split="train_r2[:50%]")
        anli_r3_train = datasets.load_dataset("facebook/anli", split="train_r3[:50%]")
        ...
        snli_train = datasets.load_dataset("snli", split="train[:70%]")
    ...
    if training_args.do_eval:
        ...
        # eval_dataset = datasets.load_dataset("snli", split='validation')
